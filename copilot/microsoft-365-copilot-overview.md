...
|                       | M365 Chat                  | Allows users to access data across their Microsoft 365 Graph and leverage LLM functionality. M365 chat can be accessed in Teams and when signed-in to Bing with an active directory account. |
